...
ActiveRecord::Schema.define(version: 2020_12_10_101631) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "last_sign_in_at", default: "2020-12-10 00:00:00"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "first_name"
    t.string "last_name"
    ...
    t.integer "days_streak", default: 0
  ...
  create_table "users_programs", force: :cascade do |t|
    ...
    t.string "final_test_status", default: "vérouillé"
